...
public class LoginSignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView signup = (TextView) findViewById(R.id.singup_big_tv);
    ...
    public void showSingUp(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(LoginSignupActivity.this, R.color.colorPrimary));
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(LoginSignupActivity.this, R.color.colorPrimary));
    ...
    public void showLogIn(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(LoginSignupActivity.this, R.color.colorAccent));
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(LoginSignupActivity.this, R.color.colorAccent));
